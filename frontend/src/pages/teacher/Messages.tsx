...
const TeacherMessages: React.FC = () => {
  ...
  const sendNewDM = async (e: React.FormEvent) => {
    ...
    try {
      ...
      refreshConversations();
      // Switch to DM view with the new recipient
              ...
              {conversations.map((conv: any) => (
                ...
                >
                  ...
                  <div className="channel-info">
                    ...
                    <div className="channel-meta">{conv.lastMessage?.substring(0, 30)}...</div>
                  </div>
          ...
          <div className="messages-main">
            ...
            <form className="chat-input" onSubmit={viewMode === 'group' ? sendGroupMessage : sendDmMessage}>
              <input
                ...
                placeholder={viewMode === 'group' ? 'Post to group...' : 'Type a message...'}
                value={newMsg}
