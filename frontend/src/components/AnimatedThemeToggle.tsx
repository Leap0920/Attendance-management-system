...
export const AnimatedThemeToggle: React.FC<{ className?: string }> = ({ className }) => {
  ...
  if (!mounted) {
    return (
      <button className={`theme-toggle-btn ${className || ''}`} disabled>
...
const SolarSwitch = ({ isDark }: { isDark: boolean }) => {
  ...
  return (
    <motion.div animate={isDark ? "checked" : "unchecked"} style={{ display: 'flex' }}>
      <motion.svg
        width="20"
        height="20"
        viewBox="0 0 25 25"
      ...
      >
        ...
        {[
          ...
          "M18.7686 19.124L20.1828 20.5382",
          "M1.40576 12.7625H3.40576",
          "M21.4058 12.7625H23.4058",
          "M4.62891 20.5406L6.04312 19.1264",
