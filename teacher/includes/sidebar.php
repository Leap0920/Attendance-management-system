<aside class="sidebar">
    ...
    <div class="sidebar-footer">
        <div class="user-card">
            <div class="avatar-initials" style="background: linear-gradient(135deg, var(--purple), var(--primary));">
            ...
            <a href="../api/auth/logout.php" class="btn btn-icon btn-ghost" title="Logout"><i
